...
const { getAllElevesController, createEleveController, getEleveController, moyennesController, EleveRang, absenceController, getBulletin} = require('../controllers/eleves.controller')
